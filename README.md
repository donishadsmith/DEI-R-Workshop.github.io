...
| 3 | Manipulating DataFrames, Conditional Statements, & User-Defined Functions | A demonstration of how to sort, filter, and manipulate dataframes using conditional statemetns, user-defined functions, and functions from popular packages in the Tidysverse (such as tidyr & dplyr) to prepare data for analysis and plotting. | 
